<template>
  <div class="flex h-screen bg-gray-50">
    ...
    <div class="flex-1 flex flex-col overflow-hidden min-h-0">
      <!-- Header -->
      <TheHeader @menu-toggle="toggleSidebar" />
...
definePageMeta({
  auth: false,      // Desactiva el módulo de autenticación de Sidebase
  middleware: [],    // Limpia cualquier otro middleware de seguridad
  layout: 'default' // Asegúrate de que use un layout que no sea el de login
});

// --- INICIO DE LA LÓGICA DEL SIDEBAR ---
